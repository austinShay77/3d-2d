    ...
    def parallel_normalization(self):
        ...
        for face in self.faces:
            for vertice in face:
                ...
                if is_first_vertice:
                    first_vertice.append([new_vertices[0], new_vertices[1], "lineto"])
                    is_first_vertice = False
                if is_moveto:
                    new_P.append([new_vertices[0], new_vertices[1], "moveto"])
                    is_moveto = False
                else:
                    new_P.append([new_vertices[0], new_vertices[1], "lineto"])
    ...
    def perspective_normalization(self):
        ...
        for face in self.faces:
            for vertice in face:
                ...
                if is_first_vertice:
                    first_vertice.append([x_prime, y_prime, "lineto"])
                    is_first_vertice = False
                if is_moveto:
                    new_P.append([x_prime, y_prime, "moveto"])
                    is_moveto = False
                else:
                    new_P.append([x_prime, y_prime, "lineto"])
            new_P.append(first_vertice[0])
            new_P.append(["stroke"])
            is_first_vertice = True
            is_moveto = True
